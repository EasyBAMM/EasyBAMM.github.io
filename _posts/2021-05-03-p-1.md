...
##### 1-1 이미지가 이미 있다면 라벨링 진행, 없으면 1-2로 이동.
...
_Export_ 클릭 시 zip파일로 라벨데이터가 받아집니다. 끝!

##### 1-2 이미지가 없다면?(Google Image Dataset이용하기)
...
<img src="\assets\images\2021-05-03\roboflow7.PNG" style="zoom: 50%;" />
